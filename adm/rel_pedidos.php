...
<h1>Relatório de Pedidos</h1>
          ...
          <thead>
            ...
            <form action="print_rel_pedidos.php" method="post" id="form_contrato" enctype="multipart/form-data" target="_blank">
			<tfoot>
              <tr>
                <th><div align="right">
              ...
              <tr>
                <td>
				  <fieldset>
                  <legend>Relatório de Pedidos</legend>                  
                  ...
                  <label class="coluna3"> Período Final
				  ...
				  <label class="coluna3">
                  Situação<br />
                  <select name="sit" id="sit"  style="width:390px">
                    <option selected>Selecione...</option>
					<option></option>
					 <option value="Pagos" selected>Pagos</option>
					 <option value="Naopagos" selected>Não Pagos</option>
