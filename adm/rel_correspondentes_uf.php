...
<div id="conteudo">
<h1>Relatório de Correspondentes - Por Estados</h1>
          <table class="telasis">
          <thead>
            <tr>
            ...
            <form action="print_rel_correspondentes_uf.php" method="post" id="form_contrato" enctype="multipart/form-data" target="_blank">
			<tfoot>
              <tr>
                <th><div align="right">
              ...
              <tr>
                <td>
				  <fieldset>
                  <legend>Relatório de Correspondentes por Estados</legend>                  
                  
				  
				  <label class="coluna3">
				  Estado<span class="VERMELHO"></span><br />
                  <select name="uf" id="uf" style="width:500px;">
                        <option>Selecione um Estado...</option>
                        <option></option>
						<option></option>
                           <?php 
						     $consultauf = mysql_query("SELECT * FROM `estados` ORDER BY nome ASC");
							 while($uf = mysql_fetch_object($consultauf)) { ;?>
					         <option value="<?php echo $uf->sigla;?>"><?php echo $uf->nome;?></option>
					       <?php  } ?>
                      </select>
                  </label>
                  <br style="clear:left;" />
				  ...
				  <label class="coluna3">
				  Tipo de Filtro<span class="VERMELHO"></span><br />
                  <select name="filtro" id="filtro" style="width:500px;">
                        <option>Selecione ...</option>
						<option></option>
                        <option value="cadastro">Estado do Correspondente</option>
						<option value="atuacao">Estado de Atuação</option>
                      </select>
                  </label>
                  <br style="clear:left;" />
