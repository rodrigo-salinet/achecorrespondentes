...
<script>
 ...
 <nav id="container_menu">
        ...
        <ul id="menu">
            ...
            <li><a href="area-do-correspondente.php">Área do Correspondete</a></li>
        </ul>
...
<form action="valida_login.php" method="post" class="form_login">

<input type="hidden" name="pagina" value="contato" />
<p><label for="LOGlogin">ACESSE SUA CONTA</label><input type="text" value=""  placeholder="E-Mail"  name="LOGlogin"/></p>
<p><a href="esqueci-senha.php" class="bt_esqueci_senha">Esqueci Minha Senha</a><label for="LOGsenha" style="display:none;">Senha</label><input type="password" value=""  placeholder="Senha" name="LOGsenha" /></p>

<p><input type="submit"  value="ACESSAR" class="bt_login"/></p>
